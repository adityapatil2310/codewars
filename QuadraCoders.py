...
def quad1(pirate, d):
    ...
    if(int(pirate.getID()) > 0 and int(pirate.getID()) < 11):
        command = random.randint(1, 4)


    if ((s[0] != "myCaptured" and s[1] != "myCaptured") or (s[1] != "myCaptured" and s[2] != "myCaptured") or (s[0] != "myCaptured" and s[2] != "myCaptured") or pirate.getCurrentFrame() < 900):
...
def quad3(pirate, d):
    ...
    if ((s[0] != "myCaptured" and s[1] != "myCaptured") or (s[1] != "myCaptured" and s[2] != "myCaptured") or (s[0] != "myCaptured" and s[2] != "myCaptured") or pirate.getCurrentFrame() < 1900):
        # in quad 2 and trying to go to opp
